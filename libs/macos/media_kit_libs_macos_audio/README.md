# [package:media_kit_libs_macos_audio](https://github.com/alexmercerind/media_kit)
...
macOS package providing audio native libraries for [`package:media_kit`](https://github.com/alexmercerind/media_kit).
