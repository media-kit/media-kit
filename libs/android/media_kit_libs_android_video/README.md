# [package:media_kit_libs_android_video](https://github.com/alexmercerind/media_kit)
...
Android package providing video (& audio) native libraries for [`package:media_kit`](https://github.com/alexmercerind/media_kit).
