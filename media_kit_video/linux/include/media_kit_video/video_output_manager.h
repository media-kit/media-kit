...
G_DECLARE_FINAL_TYPE(VideoOutputManager, video_output_manager, VIDEO_OUTPUT_MANAGER, VIDEO_OUTPUT_MANAGER, GObject)

#define VIDEO_OUTPUT_MANAGER(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), video_output_manager_get_type(), VideoOutputManager))

VideoOutputManager* video_output_manager_new(FlTextureRegistrar* texture_registrar);
 ...
 * @param texture_update_callback Callback invoked when the texture ID updates i.e. video dimensions changes.
 * @param texture_update_callback_context Context passed to |texture_update_callback|.
 */
