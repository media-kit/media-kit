...
G_DECLARE_FINAL_TYPE(TextureSW, texture_sw, TEXTURE_SW, TEXTURE_SW, FlPixelBufferTexture)

#define TEXTURE_SW(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), texture_sw_get_type(), TextureSW))
...
#define SW_RENDERING_PIXEL_BUFFER_SIZE (SW_RENDERING_MAX_WIDTH) * (SW_RENDERING_MAX_HEIGHT) * (4)
