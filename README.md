...
dependencies:
  ...
  media_kit_libs_android_video: ^1.0.7           # Android package for video native libraries.
...
dependencies:
  ...
  media_kit_libs_android_audio: ^1.0.7           # Android package for audio native libraries.
