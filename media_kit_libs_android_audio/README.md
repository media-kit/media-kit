# [package:media_kit_libs_android_audio](https://github.com/alexmercerind/media_kit)
...
Android package providing audio (only) native libraries for [`package:media_kit`](https://github.com/alexmercerind/media_kit).
